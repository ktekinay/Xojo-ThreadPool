#tag Class
Protected Class DelegateRunnerThreadPool
Inherits ThreadPool
	...
	#tag Method, Flags = &h0
		Sub Constructor(runner As RunnerMethod)
		  // Calling the overridden superclass constructor.
		  Super.Constructor
	...
	#tag DelegateDeclaration, Flags = &h0
		Delegate Sub RunnerMethod(index As Integer, data As Variant)
	#tag EndDelegateDeclaration


	#tag Property, Flags = &h21
		Private Runner As RunnerMethod
	#tag EndProperty
